        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HmacSecretEncrypted = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    DaXacThuc = table.Column<bool>(type: "bit", nullable: false),
                    NgayXacThucUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LoiXacThucGanNhat = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantHnCCredentials", x => x.TenantId);
                });

            migrationBuilder.CreateTable(
                name: "TenantOAuthTokens",
                columns: table => new
                {
                    TenantId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantOAuthTokens", x => x.TenantId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DienTich = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncOutbox_Status_NextRetryAtUtc",
                table: "SyncOutbox",
                columns: new[] { "Status", "NextRetryAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_SyncOutbox_TenantId_EntityType_EntityKey",
                table: "SyncOutbox",
                columns: new[] { "TenantId", "EntityType", "EntityKey" });

            migrationBuilder.CreateIndex(
                name: "IX_SystemLogs_TenantId_TimestampUtc",
                table: "SystemLogs",
                columns: new[] { "TenantId", "TimestampUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_MaKho",
                table: "Warehouses",
                columns: new[] { "MaKho", "TenantId" },
                unique: true);
        }
